...
```{r}
#| label: find symbols
# finds all symbols in data frame
y_symbols <- tibble(symbols = c(lower_case, 
                                 upper_case, 
                                 punctuation)) |> 
...
```{r}
#| label: alters top-secret numbers
#adds 14, multiplies 18, subtracts 257, and sqquares every number 
